window.AmbireSDK = function (opt = {}) {
    ...
    // newDiv.setAttribute('id', 'ambire-sdk-wrapper')
    // newDiv.setAttribute('class', 'sdk-overlay')
    // const subDiv = document.createElement('div')
    // subDiv.setAttribute('id', 'ambire-sdk-iframe')
    // subDiv.setAttribute('class', 'modal-window')
    // newDiv.appendChild(subDiv)
    // const closeButton = document.createElement('button')
    // closeButton.setAttribute('id', 'ambire-sdk-iframe-close')
    // const buttonText = document.createTextNode('Close iframe')
    ...
    this.showIframe = function (url) {
      ...
      self.wrapperElement.style.zIndex = 999
